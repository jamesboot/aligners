...
--genomeFastaFiles /data/WHRI-GenomeCentre/Genome/Human/hg19.GRCh38.104/Homo_sapiens.GRCh38.dna.primary_assembly.fa \
--sjdbGTFfile /data/WHRI-GenomeCentre/Genome/Human/hg19.GRCh38.104/Homo_sapiens.GRCh38.104.gtf \
--sjdbOverhang 100 \

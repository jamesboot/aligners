...
#Running cellranger for creating custom reference with mkref 
# for more details please visit https://support.10xgenomics.com/single-cell-gene-expression/software/pipelines/latest/using/tutorial_mr
# Building reference with celrlanger v5.0 is different to cellranger version 3.0.2
# Cellranger suggested to use gtf file from the Gencode and fasta file from ensemble. 
...
# SECTION 3 - Genome metadata
genome="GRCh38"
version="2020-A"

# Set up source and build directories
#build set to the name of the version of the Genome 
...
## SECTION 4 - CHANGE ONLY THIS SECTION ######################
# The url paths of the .fasta and .gtf should be changed depending on the genome reference you want to build. 
# set fasta_url to the http link path to the fasta file. 
# set fasta_in to the name of the fasta file which was downloaded. 
# set gtf_url to the http link path to the gtf file. 
# set gtf_in to the name of the gtf file which was downloaded. 
...
# Download the fasta and gtf files from the sources. 
if [ ! -f "$fasta_in" ]; then
